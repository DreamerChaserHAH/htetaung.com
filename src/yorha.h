...
//                                                                              //
// USAGE: On init call: GuiLoadStyleYorha();                                   //
//                                                                              //
...
#define YORHA_STYLE_PROPS_COUNT  32

// Custom style name: yorha
static const GuiStyleProp yorhaStyleProps[YORHA_STYLE_PROPS_COUNT] = {
    ...
    { 2, 0, 0xb2ad98ff },    // BUTTON_BORDER_COLOR_NORMAL 
    { 2, 1, 0xb4af9aff },    // BUTTON_BASE_COLOR_NORMAL 
    { 2, 2, 0x454138ff },    // BUTTON_TEXT_COLOR_NORMAL 
    { 2, 3, 0x625f54ff },    // BUTTON_BORDER_COLOR_FOCUSED 
    { 2, 4, 0x4e4b42ff },    // BUTTON_BASE_COLOR_FOCUSED 
    { 2, 5, 0xd1cdb7ff },    // BUTTON_TEXT_COLOR_FOCUSED 
    { 2, 6, 0x625f54ff },    // BUTTON_BORDER_COLOR_PRESSED 
    { 2, 7, 0x4e4b42ff },    // BUTTON_BASE_COLOR_PRESSED 
    { 2, 8, 0xd1cdb7ff },    // BUTTON_TEXT_COLOR_PRESSED 
...
#define YORHA_STYLE_FONT_ATLAS_COMP_SIZE 2126

// Font atlas image pixels data: DEFLATE compressed
static unsigned char yorhaFontData[YORHA_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle yorhaFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo yorhaFontGlyphs[189] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: yorha
static void GuiLoadStyleYorha(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < YORHA_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(yorhaStyleProps[i].controlId, yorhaStyleProps[i].propertyId, yorhaStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int yorhaFontDataSize = 0;
    unsigned char *data = DecompressData(yorhaFontData, YORHA_STYLE_FONT_ATLAS_COMP_SIZE, &yorhaFontDataSize);
    ...
    memcpy(font.recs, yorhaFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, yorhaFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
